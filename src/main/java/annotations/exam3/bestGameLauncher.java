package annotations.exam3;

import annotations.exam3.annotations.Annotations.DependsOn;
import annotations.exam3.annotations.Annotations.FinalResult;
import annotations.exam3.annotations.Annotations.Operation;
...
public class bestGameLauncher {

    public static void main(String[] args) throws InvocationTargetException, IllegalAccessException {
        BestGamesFinder bestGamesFinder = new BestGamesFinder();

        List<String> bestGameInDecendingOrder = execute(bestGamesFinder);
        System.out.println(bestGameInDecendingOrder);
    }
